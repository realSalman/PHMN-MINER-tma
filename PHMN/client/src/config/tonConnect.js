...
const getBaseUrl = () => {
  ...
  return process.env.REACT_APP_GAME_URL || process.env.REACT_APP_GAME_URL;
};
  ...
  walletAddressPromise = (async () => {
    try {
      const baseUrl = typeof window !== 'undefined' 
        ...
        : process.env.REACT_APP_GAME_URL || process.env.REACT_APP_GAME_URL || 'https://app.phoneminer.org';
